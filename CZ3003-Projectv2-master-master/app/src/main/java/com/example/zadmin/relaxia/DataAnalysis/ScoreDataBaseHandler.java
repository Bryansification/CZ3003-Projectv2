...
public class ScoreDataBaseHandler extends SQLiteOpenHelper {
    ...
    public void insertIntoTable(String gameType, int diff_level, int score, int time, String dateTime, int stars){
        ...
        Log.i(TAG, "Inserting into table. GameType: " + gameType + "diff_level: "+ diff_level + "score: " + score + "time : "+ time + "dateTime: " + dateTime + "stars: " + stars);
