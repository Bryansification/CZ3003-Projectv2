...
import com.example.zadmin.relaxia.Models.MemoryGame.BoardArrangement;
...
public class Engine implements EventObserverMemoryGame, EventObserverViewDataAnalysis{
    ...
    private void arrangeBoard() {
        ...
        MemoryGame.mPlayingGame.boardArrangement = boardArrangement;
    }
    ...
    public void onEvent(FlipCardEvent event) {
        ...
        if (MemoryGame.mFlippedId == -1) {
            ...
            if (MemoryGame.mPlayingGame.boardArrangement.isPair(MemoryGame.mFlippedId, id)) {
